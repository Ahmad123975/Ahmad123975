...
![Header](https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=220&section=header&text=Muhammad%20Ahmad&fontSize=55&fontColor=ffffff&fontAlignY=38&desc=Full-Stack%20.NET%20Developer%20%7C%20Clean%20Architecture%20%7C%20SaaS&descAlignY=58&descSize=18)
...
### 🔵 Netrex Solutions
**Full-Stack .NET Developer** &nbsp;`Jan 2025 – Present` &nbsp;| &nbsp;Onsite

- Built multi-module e-commerce platform (User, Seller, Payment, Cart)
- JWT authentication with **HttpOnly refresh token** strategy
- **Clean Architecture** · EF Core · PostgreSQL · Blazor · ASP.NET Core

</td>
<td width="50%" valign="top">

### 🔵 FutureXcel
**Full-Stack .NET Developer Intern** &nbsp;`Dec 2025` &nbsp;| &nbsp;Remote

- Built fullstack application with JWT auth and role-based access control
- Complete **Admin & User Panel** using ASP.NET Core and Blazor
...
**Full Stack Track — Rapid Render Clan** &nbsp;`2026` &nbsp;| &nbsp;Remote
...
- ⚛️ React · TypeScript · Zustand · TanStack Query
...
- Clean Architecture · JWT · FluentValidation · Serilog
...
![CQRS](https://img.shields.io/badge/CQRS-302b63?style=for-the-badge)
![Vertical Slice](https://img.shields.io/badge/Vertical_Slice-24243e?style=for-the-badge)
